...
export class UFO5Scene extends Scene {
  ...
  update() {
    ...
    if (this.seconds() > this.delay && this.seconds() < 10) {
      if (this.seconds() % 3 === 0) {
        ...
        if(this.clock===true){
          UFOs.push(new UFO3(canvas.width, canvas.width - image.height, canvas.width, -image.height, this.r, this.clock, ufo))
        }else{
          UFOs.push(new UFO3(0,  - image.height, canvas.width, -image.height, this.r, this.clock, ufo))
        }
