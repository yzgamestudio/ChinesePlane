...
export const HDImageResources = [
    ...
    ['bullet3', 'res/bullet3@2x.png'],
    ['doubleLightBullet', 'res/doubleLightBullet@2x.png'],
    ['triLightBullet', 'res/triLightBullet@2x.png'],
...
export const UDImageResources = [
    ...
    ['bullet3', 'res/bullet3@3x.png'],
    ['doubleLightBullet', 'res/doubleLightBullet@3x.png'],
    ['triLightBullet', 'res/triLightBullet@3x.png'],
